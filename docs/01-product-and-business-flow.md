...
正文。方案只描述本章功能、进入与退出状态、人物当下目标与知识边界、关键因果链、选择和
代价，以及对 Current Outline 的影响；它是 `candidates/` 中的讨论输入，不是正式正文、
...
与首遍叙述清晰作为最高创作门槛。目标读者应当连续理解发生了什么、人物依据当时所知为何
这样行动，以及行动或结果如何形成下一步条件。人物声音、项目特异性、氛围、意象和语言
技巧在此门槛内发挥作用，不能掩盖断裂因果或含混描述。

清晰度包括常用准确词汇、明确的动作与指代关系、段落主次和与叙事重要性匹配的篇幅；不得
用固定生僻字表、统一句长或程序化可读性分数替代 AI 和作者对准确正文的判断。Review 先
检查方案与连续性、因果、首遍清晰和人物行为，再检查项目声音与模板化 AI 表达；后项不能
补偿前项失败。

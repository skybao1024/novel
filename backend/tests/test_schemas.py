...
EXPECTED_SCHEMA_FILES = {
    ...
    "volume-summary.schema.json",
    "volume.schema.json",
    "character-state.schema.json",
    "change-set-operation.schema.json",
    "continuity-chapter-status.schema.json",
    ...
    "review.schema.json",
    "chapter.schema.json",
    "chapter-entity-occurrence-draft.schema.json",
    "chapter-entity-occurrence.schema.json",
    "chapter-summary.schema.json",
    "chapter-trace-draft.schema.json",
    "chapter-trace-backfill-plan.schema.json",
    "chapter-trace-backfill.schema.json",
    "chapter-trace-entity-draft.schema.json",
    "chapter-trace.schema.json",
